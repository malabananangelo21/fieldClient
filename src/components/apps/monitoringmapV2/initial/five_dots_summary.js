  ...
  const dataset = () => {
    ...
    state.five_dots_data.forEach((val) => {
      let data_format = [
        ...
        { value: val.date },
        {
          value: val.attendance1,
          style: {
            fill: {
              patternType: "solid",
              fgColor: { rgb: val.attendance1 > 0 ? "2ECC71" : "F1C40F" },
            },
          },
        },
        {
          value: val.count_assign,
          style: {
            fill: {
              patternType: "solid",
              fgColor: { rgb: val.count_assign > 0 ? "2ECC71" : "F1C40F" },
            },
          },
        },
        {
          value: val.attendance2,
          style: {
            fill: {
              patternType: "solid",
              fgColor: { rgb: val.attendance2 > 0 ? "2ECC71" : "F1C40F" },
            },
          },
        },
        {
          value: val.attendance3,
          style: {
            fill: {
              patternType: "solid",
              fgColor: { rgb: val.attendance3 > 0 ? "2ECC71" : "F1C40F" },
            },
          },
        },
        {
          value: val.attendance4,
          style: {
            fill: {
              patternType: "solid",
              fgColor: { rgb: val.attendance4 > 0 ? "2ECC71" : "F1C40F" },
            },
          },
        },
        { value: val.jo_assign },
      ...
      <Grid container spacing={1}>
        <Grid item xs={12} md={12}>
          ...
          <Button
            ...
            onClick={() =>
              setState((prev) => ({ ...prev, openFilterDots: true }))
            }
          >
            Filter
          </Button>
          <ExcelFile
            filename={
              "Summary 5 Dots" +
              "-" +
              moment(new Date(state.filter_date_start)).format("YYYY-MM-DD") +
              " - " +
              moment(new Date(state.filter_date_end)).format("YYYY-MM-DD")
            }
            element={
              <Button
                size="small"
          ...
          >
            <ExcelSheet dataSet={datasetmvp()} name="MVP"></ExcelSheet>
          </ExcelFile>
          <ExcelFile
            filename={
              "Running" +
          ...
          >
            <ExcelSheet dataSet={datasetrunning()} name="Running"></ExcelSheet>
          </ExcelFile>
        </Grid>
        <Grid item xs={12} md={12}>
          <div>
                ...
                {state.five_dots_data.map((val, index) => {
                  return (
                    <TableRow key={index}>
                      ...
                      <TableCell>{val.employee_activity}</TableCell>
