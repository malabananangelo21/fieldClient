...
import { Button, Grid, IconButton, Typography, Card, CardContent,
Dialog,
DialogTitle,
DialogContent,
AppBar,
...
const CustomTooltip = ({ active, payload, label, checkState }) => {
    if (active && payload && payload.length && payload[0].payload.count !== 0) {
        ...
        return (
            <div className="custom-tooltip card-color-data2" style={{ backgroundColor: '#fff', paddingRight: 10, paddingLeft: 10, paddingTop: 5, paddingBottom: 5, paddingLeft: 10, borderRadius: 5, width: 200 }}>
                <Typography style={{ fontSize: 18, fontWeight: 'bold', marginTop: 5 }}>Grade : {parseFloat(payload[0].payload.totalScore).toFixed(2)}%</Typography>
            </div >
        );
    }
    return null;
           ...
           >
             <TableHead>
               <TableRow>
                 ...
                 <TableCell style={{fontWeight:'bold'}}>Accuracy Rate</TableCell>
               </TableRow>
             </TableHead>
             <TableBody>
               <TableRow>
           ...
           >
             <TableHead>
               <TableRow>
                 ...
                 <TableCell style={{fontWeight:'bold'}}>Completeness Rate</TableCell>
               </TableRow>
             </TableHead>
             <TableBody>
               <TableRow>
           ...
           >
             ...
             <TableBody>
               <TableRow>
                 ...
                 <TableCell style={{fontWeight:'bold'}}>{state.break_data.absentism + '%'}</TableCell>
               </TableRow>
             </TableBody>
           </Table>
         </TableContainer>
           ...
           >
             ...
             <TableBody>
               <TableRow>
                 ...
                 <TableCell style={{fontWeight:'bold'}}>{state.break_data.tardiness + '%'}</TableCell>
               </TableRow>
             </TableBody>
           </Table>
         </TableContainer>
